<%@ Page language="c#" AutoEventWireup="true"  CodePage="936"  Inherits="DotNetTextBox.PageCode"%>
...
<div class="selfont" onmouseover="yulan('&#8482;')" onclick="crfont('&#8482;')">&#8482;</div></div>
<div class="selfont_eve lfd">
<div class="selfont" onmouseover="yulan('&reg;')" onclick="crfont('&reg;')">&reg;</div></div>
<div class="selfont_eve lfd">
<div class="selfont" onmouseover="yulan('&copy;')" onclick="crfont('&copy;')">&copy;</div></div></div></div>
